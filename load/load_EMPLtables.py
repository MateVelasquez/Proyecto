...
csv_files_and_tables = {
    'csvs\employee.csv': 'tblEmployees',
    'csvs\criticityLevelEMPL.csv': 'BW_TA_CriticityLevel_Empl',
    'csvs\caseCategoryEMPL.csv': 'BW_TA_CaseCategories_Empl',
    'csvs\AlertTypesEMPL.csv': 'BW_AlertTypes_Empl',
    'csvs\AlertCasesEMPL.csv': 'BW_TA_AlertCases_Empl'
}
