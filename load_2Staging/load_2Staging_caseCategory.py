...
class CaseCategoriesDataLoader:
...
sql_query = "SELECT * FROM BW_TA_CaseCategories"
table_name = 'BW_TA_CaseCategories'
loader = CaseCategoriesDataLoader(source_db_info, target_db_info, sql_query, table_name)
