...
class CaseCategoriesEmplDataLoader:
...
sql_query = "SELECT * FROM BW_TA_CaseCategories_Empl"
table_name = 'BW_TA_CaseCategories_Empl'
loader = CaseCategoriesEmplDataLoader(source_db_info, target_db_info, sql_query, table_name)
