...
class CriticityLevelEmplDataLoader:
...
sql_query = "SELECT * FROM BW_TA_CriticityLevel_Empl"
table_name = 'BW_TA_CriticityLevel_Empl'
loader = CriticityLevelEmplDataLoader(source_db_info, target_db_info, sql_query, table_name)
