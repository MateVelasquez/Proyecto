...
# Información de la base de datos de origen (BW_Business_Ware)
source_db_info = {
    'host': '10.10.10.2',
    'port': '3306',
    'user': 'dwh',
...
# Información de la base de datos de destino (staging)
target_db_info = {
    'host': '10.10.10.2',
    'port': '3306',
    'user': 'dwh',
...
sql_query = "SELECT * FROM BW_AlertTypes"
table_name = 'BW_AlertTypes'
loader = AlertTypeDataLoader(source_db_info, target_db_info, sql_query, table_name)
