...
class AlertCasesEmplDataLoader:
...
sql_query = "SELECT * FROM BW_TA_AlertCases_Empl"
table_name = 'BW_TA_AlertCases_Empl'
loader = AlertCasesEmplDataLoader(source_db_info, target_db_info, sql_query, table_name)
