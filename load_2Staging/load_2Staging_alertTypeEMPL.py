...
sql_query = "SELECT * FROM BW_AlertTypes_Empl"
table_name = 'BW_AlertTypes_Empl'
loader = AlertTypeEmplDataLoader(source_db_info, target_db_info, sql_query, table_name)
