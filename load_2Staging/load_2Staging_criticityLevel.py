...
class CriticityLevelDataLoader:
...
sql_query = "SELECT * FROM BW_TA_CriticityLevel"
table_name = 'BW_TA_CriticityLevel'
loader = CriticityLevelDataLoader(source_db_info, target_db_info, sql_query, table_name)
